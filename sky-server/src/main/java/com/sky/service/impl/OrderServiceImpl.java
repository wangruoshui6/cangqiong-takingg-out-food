...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Transactional
    public OrderSubmitVO submitOrder(@RequestBody OrdersSubmitDTO ordersSubmitDTO) {
    ...
    private void checkOutOfRange(String address) {
        if (shopAddress == null || shopAddress.trim().isEmpty() || ak == null || ak.trim().isEmpty()) {
            throw new OrderBusinessException("未配置门店地址或百度地图AK");
        }
